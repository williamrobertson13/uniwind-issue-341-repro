	...
	return (
		<View className="flex-wrap gap-6 p-1 bg-purple-50 rounded-3xl border-dashed border-2">
			...
			<Pressable className="px-7 py-2 bg-purple-900 active:bg-purple-700 rounded-md">
				<Text className="text-2xl font-semibold text-gray-900">Screen 413</Text>
			</Pressable>
			<Text className="text-sm text-gray-700 italic underline tracking-normal">item-413</Text>
		</View>
	);
}
