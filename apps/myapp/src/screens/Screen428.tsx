	...
	return (
		<View className="flex-row-reverse gap-1 p-5 bg-yellow-100 rounded shadow-lg">
			...
			<Pressable className="px-4 py-1 bg-purple-600 active:bg-purple-700 rounded-md">
				<Text className="text-base font-semibold text-gray-600">Screen 428</Text>
			</Pressable>
			<Text className="text-sm text-gray-700 italic underline tracking-tight">item-428</Text>
		</View>
	);
}
