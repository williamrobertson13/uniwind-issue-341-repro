	...
	return (
		<View className="flex-row-reverse gap-1 p-5 bg-yellow-100 rounded shadow-lg">
			...
			<Pressable className="px-4 py-1 bg-purple-300 active:bg-purple-700 rounded-md">
				<Text className="text-base font-semibold text-gray-300">Screen 308</Text>
			</Pressable>
			<Text className="text-sm text-gray-700 italic underline tracking-tight">item-308</Text>
		</View>
	);
}
