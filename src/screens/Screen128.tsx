	...
	return (
		<View className="flex-row gap-2 p-4 bg-gray-100 rounded-lg shadow-md">
			...
			<Pressable className="px-4 py-1 bg-purple-300 active:bg-purple-700 rounded-md">
				<Text className="text-base font-semibold text-gray-300">Screen 128</Text>
			</Pressable>
			<Text className="text-sm text-gray-700 italic underline tracking-tight">item-128</Text>
		</View>
	);
}
