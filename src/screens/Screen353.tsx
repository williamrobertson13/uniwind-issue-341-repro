	...
	return (
		<View className="flex-col gap-3 p-6 bg-blue-50 rounded-xl border border-blue-200">
			...
			<Pressable className="px-7 py-2 bg-purple-300 active:bg-purple-700 rounded-md">
				<Text className="text-2xl font-semibold text-gray-300">Screen 353</Text>
			</Pressable>
			<Text className="text-sm text-gray-700 italic underline tracking-normal">item-353</Text>
		</View>
	);
}
