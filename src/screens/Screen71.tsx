...
export function Screen71() {
	return (
		<View className="flex-row gap-2 p-4 bg-gray-7100 rounded-lg shadow-md">
			...
			<Pressable className="px-4 py-2 bg-purple-600 active:bg-purple-700 rounded-md">
				<Text className="text-base font-semibold text-white">Screen 71</Text>
			</Pressable>
			<Text className="text-sm text-gray-700 italic underline">item-71</Text>
		</View>
	);
}
